      ...
      <div class="mx-auto flex h-20 max-w-screen-2xl items-center justify-between sm:px-6 lg:px-8">
        <div class="flex items-center">
          ...
          <div x-data="{ isActive: false }" class="relative">
            <div class="inline-flex items-center overflow-hidden bg-white">
            ...
            <div class="lg:hidden absolute left-0 z-10 mt-2 w-56 rounded-md border border-gray-100 bg-white shadow-lg" role="menu" x-cloak x-transition x-show="isActive" x-on:click.away="isActive = false" x-on:keydown.escape.window="isActive = false">
        ...
        <div class="flex flex-1 items-center justify-end">
          <nav aria-label="Site Nav" class="navigation-main hidden lg:flex lg:gap-4 lg:text-xs lg:font-bold lg:uppercase lg:tracking-wide lg:text-gray-500">
            <?php
            wp_nav_menu(
              array(
                'theme_location' => 'menu-1',
